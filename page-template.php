...
$paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
 ...
 $args = array(
    ...
    $portfolio_project = new WP_Query( $args );
 
 if ($portfolio_project-> have_posts() ) :
  while ($portfolio_project-> have_posts() ) :$portfolio_project-> the_post(); ?>
        ...
        <?php 
        $total_pages = $portfolio_project->max_num_pages;
